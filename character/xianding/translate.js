...
const translates = {
	...
	taohuang: "陶璜",
	dczhijue: "制绝",
	dczhijue_info: "锁定技，你计算与其他角色的距离-2。当你造成伤害后，将手牌摸至体力上限且此技能失效直到回合结束。",
	dcweiwei: "维卫",
	dcweiwei_info: "每回合限一次，你成为其他角色使用牌的目标后，你可与其各摸两张牌并交换一张手牌，然后你可使用其交给你的牌；若你交给其的牌此回合结束时仍在其手牌中则对其造成一点伤害。",
	dc_sb_zhuran: "新杀谋朱然",
	dc_sb_zhuran_prefix: "新杀|谋",
	dcsbzhenyu: "镇御",
	dcsbzhenyu_info: "当你需要使用【杀】或【闪】时，你可以横置一名角色，然后视为使用此牌。若如此做。此技能失效直到每轮结束或你从手牌中使用基本牌。",
	dcsbjielu: "截路",
	...
	dcsbhengye: "横野",
	dcsbhengye_info: "锁定技，①你造成属性伤害后，令你以下一项数值+1（至多+3）：1.摸牌阶段摸牌数；2.出牌阶段使用【杀】的次数；3.手牌上限，4.攻击范围。②若你〖横野①〗中任意项已+3，每回合开始时，你回复1点体力。③你杀死一名角色后，重置此技能。",
	dcsbyingbo: "英博",
