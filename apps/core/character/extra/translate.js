...
const translates = {
	...
	mbtiantao: "天涛",
	mbtiantao_info: "锁定技，结束阶段，你弃置一个区域里的所有牌(至少一张)，然后依次弃置任意名其他角色相同区域各一张牌， 因此弃置牌且未弃置【杀】的角色失去1点体力。",
	mbxinghun: "星魂",
	mbxinghun_info: "出牌阶段限一次，你可以观看的牌堆顶五张牌，用任意张手牌与其中的等量张牌进行交换并任意排序，然后你令一名其他角色展示你的手牌与牌堆顶的共计X张牌，你对其依次使用其中的【杀】。",
	mbshenpei: "神霈",
