...
const translates = {
	...
	mbtizhong: "体重之神",
	mbgunyuan: "滚圆",
	mbgunyuan_info: "锁定技，①你每轮首次进入濒死时将体力值回复至1点并增加1点体力上限（至多+3）；②你的手牌上限等于你的体力上限。",
	mbzuandai: "钻袋",
	mbzuandai_info: "你的出牌阶段开始时，你可以从牌堆或弃牌堆随机使用一张装备牌并摸一张牌，然后立即结束出牌阶段。",
	mbkeai: "可爱之神",
	mbmaimeng: "卖萌",
	mbmaimeng_info: "你的体力值变化后，你选择一项执行：1.摸X张牌并防止你本回合下次受到的伤害；2.令一名其他角色交给你x张牌且其本回合使用的下一张牌无效（X为本回合此技能发动次数）",
	mbweiqu: "委屈之神",
	mb_weiqu: "委屈",
	mb_weiqu_info: "每回合限两次，你成为实体牌的唯一目标时，可选择一项执行：1.弃置装备区所有牌并令此牌无效，2.弃置所有手牌并摸等量牌。（当你在一回合内执行过不同的两项结算完成时，你摸两张牌）",
	mbjueze: "抉择之神",
	mbhuibian: "慧辨",
	mbhuibian_info: "出牌阶段，你可选择两名角色各一张手牌并猜测这两张牌颜色是否相同,若你猜对，你获得并展示这两张牌；若你猜错，你弃置这两张牌且此技能失效至本回合结束。",
	mbbianhuan: "变幻之神",
	mbbaibian: "百变",
	mbbaibian_info: "你的回合开始或受到伤害后，随机获得一个喵喵杀中的武将技能直到你的回合结束",
	mbshuimian: "睡眠之神",
	mbkeshui: "瞌睡",
	mbkeshui_info: "你的回合限一次，你的每个阶段开始时你可跳过此阶段（准备与结束阶段除外），然后你使用牌堆顶一张牌，此牌结算后对随机一个目标额外结算一次，若此牌不可使用，你获得此牌并跳过本回合你的下个阶段且可再次发动此技能",
	mbnizhuan: "逆转之神",
	mbfanzhuan: "反转",
	mbnizhuan_info: "每轮限一次，你可以将你的体力值调整为已损失体力值并摸变化值张牌",
	mbniyun: "逆运",
	mbniyun_info: "你的攻击范围，使用杀次数均+X（X为你已损失体力值）",
	mbmeitui: "美腿之神",
	mbshentui: "伸腿",
	mbshentui_info: "出牌阶段限一次，你可令你的攻击范围+1并视为使用一张【杀】，你使用点数小于攻击范围的【杀】不限次数且不可响应，使用点数大于攻击范围的【杀】不限距离且伤害+1.",
	mbxurui: "蓄锐",
	mbxurui_info: "锁定技，你的回合结束时，若你本回合未造成伤害，你摸攻击范围张牌（至多为5）",
	gongbaiwan: "宫百万",
	mbhaoshi: "好食",
	mbhaoshi_info: "你造成或受到伤害后，你摸一张牌并将一张牌置于武将牌上，每回合结束时，若你武将牌上的牌点数总计大于等于100，你获得一个额外回合并获得这些牌。",
};
