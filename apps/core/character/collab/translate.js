...
const translates = {
	...
	mbweiqu: "委屈之神",
	mb_weqiu: "委屈",
	mbweiqu_info: "每回合限两次，你成为实体牌的唯一目标时，可选择一项执行：1.弃置装备区所有牌并令此牌无效，2.弃置所有手牌并摸等量牌。（当你在一回合内执行过不同的两项结算完成时，你摸两张牌）",
	mbjueze: "抉择之神",
	mbhuibian: "慧辨",
	...
	mbshuimian: "睡眠之神",
	mbkeshui: "瞌睡",
	mbshuimian_info: "你的回合限一次，你的每个阶段开始时你可跳过此阶段（准备与结束阶段除外），然后你使用牌堆顶一张牌，此牌结算后对随机一个目标额外结算一次，若此牌不可使用，你获得此牌并跳过本回合你的下个阶段且可再次发动此技能",
	mbnizhuan: "逆转之神",
	mbfanzhuan: "反转",
	...
	gongbaiwan: "宫百万",
	mbhaosi: "好食",
	mbhaosi_info: "你造成或受到伤害后，你摸一张牌并将一张牌置于武将牌上，每回合结束时，若你武将牌上的牌点数总计大于等于100，你获得一个额外回合并获得这些牌。",
};
