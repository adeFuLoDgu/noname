const translates = {
	...
	std_niujin: "标牛金",
	stdcuorui: "挫锐",
	stdcuirui_info: "游戏开始时和当你杀死其他角色时，你可以将手牌摸至X张（X为场上角色数且至多为7）",
	stdx_ganfuren_prefix: "标",
	stdx_ganfuren: "标甘夫人",
	stdxzhixie: "智诫",
	stdxzhixie_info: "每轮限一次，一名角色出牌阶段开始时，你可以展示其一张手牌。其此阶段前三次使用与此牌类别相同的牌时，你摸一张牌。 ",
	stdxshushen: "淑慎",
	stdxshushen_info: "每回合结束时，若你于此回合获得了三张或更多牌，你可以令一名其他角色回复1点体力。",
	...
	std_caojinyu: "标曹金玉",
	stdyuqi: "隅泣",
	stdyuqi_yuqi_info: "与你距离小于等于你当前体力的角色受到伤害后，你可以令其摸一张牌。",
	stdshanshen: "善身",
	stdshanshen_info: "当一名角色死亡时，若伤害来源不是你，你可以回复1点体力。",
	std_lvboshe_prefix: "标",
	std_lvboshe: "标吕伯奢",
	stdfushi: "缚矢",
	std_fushi_info: "你与其距离1以内的角色每回合首次使用的【杀】 结算完成后，你获得之。你可以将任意张【杀】当成一张可以指定至多等量名目标的【杀】使用。",
	std_wuke_prefix: "标",
	std_wuke: "吴珂",
	stdanda: "谙达",
