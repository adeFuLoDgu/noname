...
const translates = {
	...
	olshanjia: "缮甲",
	olshanjia_info: "①游戏开始时，你获得3枚“损”标记。②当你失去一张装备牌后，你失去1枚“损”标记。③出牌阶段限一次，你可以摸三张牌，然后你可以使用一张【杀】。本阶段你使用下X张手牌时弃置一张牌（X为你此时拥有的“损”标记数）；本阶段结束时，若你本阶段未因此法弃置过非装备牌，则你可以视为使用一张无距离限制的【杀】。",
	ol_zhaozhong: "赵忠",
	olpengbi: "朋比",
