...
const translates = {
	...
	zhengnan: "征南",
	zhengnan_info: `其他角色死亡后，你可以摸三张牌并获得下列技能中的任意一个：${get.poptip("new_rewusheng")}${get.poptip("oldangxian")}和${get.poptip("rezhiman")}。`,
	xinzhengnan: "征南",
	xinzhengnan_info: `当一名角色进入濒死状态时，若你未因其发动过〖征南〗，则你回复1点体力并摸一张牌并获得下列技能中的任意一个：${get.poptip("new_rewusheng")}、${get.poptip("xindangxian")}和${get.poptip("rezhiman")}（若技能全部拥有则改为摸三张牌。你以此法获得的${get.poptip("xindangxian")}结算时视为已发动过${get.poptip("xinfuli")}）。`,
	xiefang: "撷芳",
