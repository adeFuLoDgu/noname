...
export class Library {
	...
	arenaReady = [
		...
		function () {
			...
			document.documentElement.style.setProperty("--cardback-url", `url(${lib.assetURL}` + (location.href.indexOf(".github.io") == -1 ? "" : (import.meta.env.VITE_BASE_PATH || "")) +`/${url})`);
		},
	];
	onfree = [];
	inpile = [];
